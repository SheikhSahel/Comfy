...
const Filters = () => {
    ...
    return (
        <Form className='bg-base-200 rounded-md px-8 py-4 grid gap gap-x-4 gap-y-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center'>
            {/* SEARCH */}
            ...
            {/* ORDER */}
            <FormSelect label='sort-by' name='order' list={['a-z', 'z-a', 
            'high', 'low']} size='select-sm' defaultValue={order}/>
