    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-24 items-center'>
            <div>
                ...
                <p className='mt-8 max-w-xl text-lg leading-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia minus voluptates suscipit ipsam quaerat voluptatem veritatis et repellendus. Quam, explicabo!</p>
